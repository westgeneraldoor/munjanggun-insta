...
> **DEC-026 적용:** 대시보드 데이터 기반 비율 변경. 문제 해결형 캐러셀이 조회수 1~5위 독점.

| 축 | 권장 비율 | 핵심 목적 | 대표 소재 | 비고 |
|----|----------|----------|----------|------|
| **문제 해결형 캐러셀** | **45%** | 저장, 공유, DM | 손실회피, 실수방지, 공감형 훅 | DEC-026 신설 |
| 리얼 현장 숏폼 | 25% | 신뢰, 문의 | 실측 장면, Before/After, 시공 과정 | 유지 |
| 광고 전환 소재 | 15% | 예약, DM | 무료 실측, 리뷰 신뢰, 추가금 방지 | 5% 감소 |
| 정보 제공형 캐러셀 | 10% | 저장, 신뢰 | 체크리스트, TOP N, 비교표 | 기존 35%에서 대폭 축소 |
| 블로그 파생 + 친밀도 | 5% | 자산 재활용, 친근감 | 블로그 요약, 캐릭터 Q&A | 통합 축소 |
...
### 문제 해결형 캐러셀 (v4.1 기본 — 70%)

문제 해결형 캐러셀은 공감과 전환을 목표로 한다.

구조:
1. 훅: 문제 제시 (손실회피/실수방지/공감형)
2. 공감: "이 상황 겪어봤다면..."
3. 원인: 왜 이런 일이 생기는지
4. 해결: 구체적 해결 방법
5. 제품 연결: 자연스러운 솔루션 제시
6. CTA: 댓글 유도 + 무료 실측
7. 캡션카드: 인스타 본문 + 해시태그

### 정보 제공형 캐러셀 (30%)

정보 제공형 캐러셀은 저장과 신뢰를 목표로 한다.
...
1. `docs/collaboration/agency_feedback.md`
2. `instagram/monthly_calendar_YYYY_MM.md`
3. `data/registry/performance_log.md`
4. `docs/collaboration/shooting_request_template.md`
