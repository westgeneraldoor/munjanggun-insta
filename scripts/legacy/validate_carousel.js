 ...
 * 
 * 사용법:
 *   node scripts/legacy/validate_carousel.js <html-file>
 *   node scripts/legacy/validate_carousel.js content/published/html-legacy/013_우리집중문선택가이드.html
 * 
 * 검증 항목 (13개):
 *   1. 파일 확장자 .html
...
if (args.length === 0) {
  console.log('사용법: node scripts/legacy/validate_carousel.js <html-file>');
  console.log('예시:   node scripts/legacy/validate_carousel.js content/published/html-legacy/013_우리집중문선택가이드.html');
  process.exit(0);
}
